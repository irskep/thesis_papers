...
\begin{figure}
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_list}}
...
\begin{figure}
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_sublist}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_pathway}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=4in]{fig/kegg/pathway_diagram}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=3in]{fig/kegg/node_legend}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_kegg_web_site}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_selection_no_info}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_animals_only_list}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_animals_only_graph}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=5in]{fig/kegg/screenshot_selection_info}}
