...
\begin{figure}
    \center{
        \includegraphics[width=4in]{kegg/figures/master_detail}}
...
\keggapp divides the screen into a \textbf{master-detail interface}. The
...
\begin{figure}[hbt]
    \center{
        \includegraphics[width=3in]{kegg/figures/pathway_diagram}}
...
\begin{figure}[hbt]
    \center{
        \includegraphics[width=2in]{kegg/figures/node_legend}}
