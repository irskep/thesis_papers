...
\begin{figure}[htbp]
    \center{
        \includegraphics[width=4.5in]{fig/smda/screenshot_list}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=4.5in]{fig/smda/screenshot_glycolysis}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=3in]{fig/smda/screenshot_glycolysis_popover}}
...
\begin{figure}[hbtp]
    \center{
        \includegraphics[width=2in]{fig/smda/screenshot_pathway_list_popover}}
