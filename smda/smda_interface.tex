...
\begin{figure}[htb]
    \center{
        \includegraphics[width=\textwidth]{fig/smda/screenshot_smda_list}}
    \caption{\label{fig:screenshot_smda_list} List of measurements in SMDA}
\end{figure}

\begin{figure}[htb]
    \center{
        \includegraphics[width=\textwidth]{fig/smda/screenshot_smda_add_reaction}}
    \caption{\label{fig:smda_add_reaction} Adding a reaction in SMDA}
\end{figure}

\begin{figure}[htb]
    \center{
        \includegraphics[width=\textwidth]{fig/smda/screenshot_smda_edit_measurement}}
...
\begin{figure}[htb]
    \center{
        \includegraphics[width=\textwidth]{fig/smda/screenshot_smda_results}}
...
\begin{figure}[htb]
    \center{
        \includegraphics[width=\textwidth]{fig/smda/screenshot_smda_results_highlight}}
